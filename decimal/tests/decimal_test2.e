...
--		add_boolean_case (agent test111)	-- fails becuase DECIMAL_WRAPPER is not precise enough. (MA_DECIMAL used a shared context that defines the precision)
		add_boolean_case (agent test112)
		add_boolean_case (agent test113)
		add_boolean_case (agent test114)
--		add_boolean_case (agent test115)	-- same as test111
--		add_boolean_case (agent test116)	-- same as test111
--		add_boolean_case (agent test117)	-- same as test111
...
--		add_boolean_case (agent test219)	-- same as test111
		add_boolean_case (agent test220)
--		add_boolean_case (agent test221)	-- same as test111
--		add_boolean_case (agent test222)	-- same as test111
--		add_boolean_case (agent test223)	-- same as test111
--		add_boolean_case (agent test224)	-- same as test111
--		add_boolean_case (agent test225)	-- same as test111
--		add_boolean_case (agent test226)	-- same as test111
...
--			print(answer.precise_out)
			Result := answer.precise_out ~ "0.3333333333333333333333333333333333333"
			check Result end
			...
			answer := two/three
--			print(answer.precise_out)
			Result := answer.precise_out ~ "0.6666666666666666666666666666666666667"
			check Result end
		end
	...
	test101: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test101: test addition: 99.9 + 2.1 = 102")
	...
	test102: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test102 (addition): 99.90000000001 + 0000000000000.100000000110000000090000 = 100.00000000012000000009")
	...
	test110: BOOLEAN
		...
		do
			...
			comment ("test111 (addition): 4635743657353.578395757439573577775767535734859364543534534645567578564564353426467456452675856245564675734645 + -4635743657353.578395757439573577775767535734859364543534534645567578564564353426467456452675856245564675734645 = 0")
	...
	test115: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test115 (addition):  + 1 = ")
	...
	test116: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test116 (addition): . + 1 = .")
			create sn1.make_from_string (".")
			create sn2.make_from_string ("1")
			answer := sn1 + sn2
			Result := equal(answer.precise_out, ".")
	...
	test117: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test117 (addition): 0. + 1 = 1.")
	...
	test219: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test219 (subtraction): 3512765361.123812789378917389423472374238974892374982374 - 27893.234723894723897893274326578246826346 = 3512737467.889088894655019496149145795992148546374982374")
			create sn1.make_from_string ("3512765361.123812789378917389423472374238974892374982374")
			create sn2.make_from_string ("27893.234723894723897893274326578246826346")
			answer := sn1 - sn2
	...
	test221: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test221 (subtraction): 999999.9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999 - 999999 = 0.9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999")
			create sn1.make_from_string ("999999.9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999")
	...
	test222: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test222 (subtraction):  - 1 = ")
			create sn1.make_from_string ("")
			create sn2.make_from_string ("1")
			answer := sn1 - sn2
	...
	test223: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test223 (subtraction): .5734895734895789347895634789573490583904587624875893534890589038649068908790356890585649578935734897689764897869057890576987935768573465893276857468978968234753897583495734895734895738945738945738943895738957357 - 1 = .5734895734895789347895634789573490583904587624875893534890589038649068908790356890585649578935734897689764897869057890576987935768573465893276857468978968234753897583495734895734895738945738945738943895738957357")
			create sn1.make_from_string (".5734895734895789347895634789573490583904587624875893534890589038649068908790356890585649578935734897689764897869057890576987935768573465893276857468978968234753897583495734895734895738945738945738943895738957357")
			create sn2.make_from_string ("1")
			answer := sn1 - sn2
			Result := equal(answer.precise_out, ".5734895734895789347895634789573490583904587624875893534890589038649068908790356890585649578935734897689764897869057890576987935768573465893276857468978968234753897583495734895734895738945738945738943895738957357")
	...
	test224: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test224 (subtraction): 1 -  = -")
			create sn1.make_from_string ("1")
	...
	test225: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test225 (subtraction): 1. - 1 = 0.")
	...
	test226: BOOLEAN
		...
		local
			...
			answer: DECIMAL
		do
			comment ("test226 (subtraction): 1 - 1. = -0.")
			create sn1.make_from_string ("1")
