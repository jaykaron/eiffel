...
**Hint**: You may wish to use the IDE to automaticall generate the BON class diagram (or UML if you prefer). This diagram will assist you in underatnding the architecture of the syste,
